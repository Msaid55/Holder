...
export default function PopularItems() {
  ...
  const items = [
    { title: "Caesar Salad", price: "$25", img: itms30, category: "Popular" },
    { title: "Blueberry Ice Cream", price: "$10", img: Itms31, category: "Popular" },
    { title: "Cobb Salad", price: "$20", img: Eitms33, category: "Popular" },
    { title: "Virgin Mojito", price: "$15", img: Kiwifruit34, category: "Popular" },
  ].map((it) => ({
    ...it,
    id: `${it.category}-${it.title}`.replaceAll(" ", ""),
  }));
