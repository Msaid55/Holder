        ...
        <div className="mx-auto h-[595px] flex justify-between relative px-4 md:px-8 lg:px-16">
            ...
            <section className="bg-white w-[609px] h-[513px] mt-[82px]">
              <div className="bg-white  w-[609px] h-full">
                <h1 className="text-[60px] font-bold  w-full h-[140px] leading-tight text-black slide-left opacity-0" style={{animationDelay: "0s"}}>
                ...
                <p className="w-[508px] mt-4 h-[105px] text-[20px] text-black slide-left opacity-0" style={{animationDelay: ".2s"}}>
                ...
                <div className="flex w-[280px] mt-10 justify-between slide-left opacity-0" style={{animationDelay: ".4s"}} >
